...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("walletrpc/walletkit.proto", :syntax => :proto3) do
    ...
    add_enum "walletrpc.WitnessType" do
      ...
      value :COMMITMENT_NO_DELAY_TWEAKLESS, 14
      value :COMMITMENT_TO_REMOTE_CONFIRMED, 15
      value :HTLC_OFFERED_TIMEOUT_SECOND_LEVEL_INPUT_CONFIRMED, 16
      value :HTLC_ACCEPTED_SUCCESS_SECOND_LEVEL_INPUT_CONFIRMED, 17
      value :LEASE_COMMITMENT_TIME_LOCK, 18
      value :LEASE_COMMITMENT_TO_REMOTE_CONFIRMED, 19
      value :LEASE_HTLC_OFFERED_TIMEOUT_SECOND_LEVEL, 20
      value :LEASE_HTLC_ACCEPTED_SUCCESS_SECOND_LEVEL, 21
      value :TAPROOT_PUB_KEY_SPEND, 22
    end
